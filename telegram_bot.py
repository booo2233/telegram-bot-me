     ...
     if update.message.text:
            ...
            await update.message.reply_text(response_of_image, parse_mode="Markdown")
              ...
              if caption_video == None:
                     ...
                     response_of_video = await video_response(caption_video, video_name)

                     await update.message.reply_text(response_of_video)
               
     elif update.message.voice:
            await update.message.reply_text("me its me audio") 
            chat_id = update.message.chat.id
            ...
            response_audio = await voice(audio_name)

            await update.message.reply_text(response_audio, parse_mode="Markdown")
